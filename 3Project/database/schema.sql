...
CREATE TABLE course_teachers (
    course_teachers_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE course_students (
    course_students_id INT AUTO_INCREMENT PRIMARY KEY,
    course_id INT NOT NULL,
...
CREATE TABLE exam_questions (
    exam_questions_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE student_answers (
    student_answers_id INT AUTO_INCREMENT PRIMARY KEY,
    ...
    FOREIGN KEY (exam_results_id)
        REFERENCES exam_results(exam_results_id)
        ON DELETE CASCADE,
